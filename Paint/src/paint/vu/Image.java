...
public class Image extends JPanel{
    ...
    public static int couleurChoisie=0;public static int taillePinceau=1;

    public static Color pinceau;

    public static int nbrImage=0;
    public static int taillePixel=10;
   ...
   public Image(int H , int L) {
       int tmp =min(MaFenetre.tailleFenetre.width/L,MaFenetre.tailleFenetre.height/H);
       if (tmp==0) {
           taillePixel=1;
       }
       else{
...
//        return new Dimension(500, 500);
    ...
    public class ImageComp extends JComponent implements MouseListener,MouseMotionListener{
        private ArrayList<Calque> calque= new ArrayList<>();

        public int HauteurPixel,LargeurPixel;
        ...
        public ImageComp(int hauteur,int largeur) {
            nbrImage++;
    ...
    //        dimension.height-=150;
            return new Dimension(taillePixel*calque.get(0).getPixel().get(0).size()+100 ,taillePixel*calque.get(0).getPixel().size()+100 );
        }
